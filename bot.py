...
8. НОВАЯ рабочая задача. Триггеры: "добавь задачу", "задача:", "нужно сделать", "поставь задачу", "создай задачу".
Формат может быть любым, в том числе многострочным:
"Добавь задачу:\nНазвание - Человек - Направление - приоритет - статус"
"Добавь задачу:\nПротестировать отправку - Галия - АЭлит - важно - в работе"
Разделители: тире (-), запятая, или просто пробел.
{"type": "new", "task_name": "название задачи", "responsible": "имя или Марго", "direction": "АЭлит или Контент или Фокус-группа или Общее", "priority": "🔥 Срочно или ⚡ Важно или 📌 Обычное", "deadline": "YYYY-MM-DD или null", "status": "В работе или Ждём или Идея или Готово"}
